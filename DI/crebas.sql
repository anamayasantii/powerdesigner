/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     26/09/2023 09:29:19                          */
/*==============================================================*/
...
alter table PENJUALAN add constraint FK_RELATIONSHIP_3 foreign key (PEM_ID)
      references PEMBELI (ID) on delete restrict on update restrict;
